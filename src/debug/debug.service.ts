...
[dependencies]`;
  ...
  constructor(private configService: ConfigService) {
    ...
    this.dapDisconnectTimeout = this.configService.get<number>('debug.timeouts.dapDisconnect', 2000);
   ...
   *
   * Process:
   * 1. Try graceful DAP disconnect (2-second timeout)
  ...
  async terminateSession(sessionId: string): Promise<boolean> {
    ...
    try {
      // Step 1: Try graceful DAP disconnect (automatically uses 2-second timeout)
